...
class AuthorizationHandler extends DbConn
{
    ...
    /**
     * Checks if current user belongs to a certain role
     *
     * @return boolean
     */
    ...
    {
        return ($this->checkRole($this->checkSessionKey("uid"), "Media") != false || $this->isSuperAdmin()) && $this->sessionValid();
    }
    public function isHR(): bool
    {
        return ($this->checkRole($this->checkSessionKey("uid"), "Examiners & HR") != false || $this->isSuperAdmin()) && $this->sessionValid();
    }
    ...
    {
        return ($this->checkRole($this->checkSessionKey("uid"), "Driver") != false || $this->isSuperAdmin()) && $this->sessionValid();
    }
    public function isStaff(): bool
    {
        return ($this->checkRole($this->checkSessionKey("uid"), "Staff") != false || $this->isSuperAdmin()) && $this->sessionValid();
    }
