...
try {
    ...
    $pw2 = $_POST['password2'];
    $tmp_id = $_POST['tmp_id'];
    $userarr = array(array('id'=>$newid,'tmp_id'=>$tmp_id, 'username'=>$newuser, 'email'=>$newemail, 'pw'=>$pw1));
