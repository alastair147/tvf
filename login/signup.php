...
<body style="background-image: url(images/backg.png); background-size: 100%; color:#a8eaff;">
    ...
    <div class="container logindiv">
        ...
        <div class="col-sm-4">
            <form class="text-center" id="usersignup" name="usersignup" method="post" action="ajax/createuser.php">
                ...
                <div class="form-group">
                    <input name="tmp_id" id="tmp_id" type="text" class="form-control input-lg" placeholder="TruckersMP ID"> </div>
                <div class="form-group">
