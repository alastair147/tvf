        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent  bg-primary  navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <?php echo '<a class="navbar-brand" href="#pablo">All User\'s Logged Jobs</a>' ?>
                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <?php
                                                    ...
                                                    if ($sql->rowCount() > 0 && $auth->isSuperAdmin() || $auth->isAdmin()) {
                                            ...
                                            <tbody>";
                                                        ...
                                                        foreach ($result as $row) {
                                                            echo "<tr><td>".$row["id"]."</td><td>".$row["date"]."</td><td>".$row["username"]."</td><td>".$row["pickup_city"]."</td><td>".$row["destination_city"]."</td><td>".$row["cargo"]."</td><td><a href='viewjob.php?id={$row['id']}'>View Job</a></td><td><a href='common/deletejob.php?id={$row['id']}&user={$_SESSION['uid']}'>Delete</a></td>";
                                                        }
                                                        echo "</tr>";
                                                        echo "</table>";
                                                    }
                                            ...
                                            <tbody>";
                                                        // output data of each row
                                                        foreach ($result as $row) {
                                                            echo "<tr><td>".$row["id"]."</td><td>".$row["date"]."</td><td>".$row["username"]."</td><td>".$row["pickup_city"]."</td><td>".$row["destination_city"]."</td><td>".$row["cargo"]."</td><td><a href='viewjob.php?id={$row['id']}'>View Job</a></td>";
                                                        }
                                                        echo "</tr>";
                                                        echo "</table>";
                                                    }
