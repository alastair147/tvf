        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent  bg-primary  navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <?php echo '<a class="navbar-brand" href="#pablo">All Leave Forms</a>' ?>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <?php
                                                ...
                                                $sql = $conn->prepare("SELECT id, username, date, enddate, leaving, reason FROM loa");
                                                $sql->execute();
                                                $result = $sql->fetchAll();
                                                ...
                                                <tbody>";
                                                    ...
                                                    foreach ($result as $row) {
                                                        echo "<tr><td>".$row["username"]."</td><td>".$row["date"]."</td><td>".$row["enddate"]."</td><td>".$row["leaving"]."</td><td>".$row["reason"]."</td><td><a href='../common/deleteloaform.php?id={$row['id']}'>Delete</a></td>";
                                                    }
                                                    echo "</tr></table>";
                                                } else {
                                                    echo "0 results";
