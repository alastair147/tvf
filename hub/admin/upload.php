        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent  bg-primary  navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <?php echo '<a class="navbar-brand" href="#pablo">Upload a Downloadable File</a>' ?>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title">Upload a new Skin/Download</h4>
                                    <p class="card-category">Media and Leader use only.</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <h4>Please wait a moment.... <br><br><strong>Once you have uploaded the file, Please go to downloads and make sure it has appeared!</strong></h4>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <script type="text/javascript">
                                                cloudinary.openUploadWidget(
                                                    {
                                                        cloud_name: 'theveteranfleet',
                                                        upload_preset: 'tvfunsigned',
                                                        sources: [ 'local']},
