    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent  bg-primary  navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <?php echo '<a class="navbar-brand" href="#pablo">Downloads</a>' ?>
                </div>
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="imagebox">
                        <img src="assets/img/daf-xf.png" alt="..." style="width:100%;">
                        <div class="centered" style="background-color: rgba(12,12,12,0.65); border-style: solid;border-radius: 10px;">
                            <h5>DAF XF 105</h5>
                        </div>
                    </div>
                </div>
